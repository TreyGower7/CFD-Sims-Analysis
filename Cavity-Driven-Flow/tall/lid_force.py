...
def main():
    ...
    x = []
    for i in range(4):
        url_l1 = "https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/tall/RE" + str(Re[i]) + "/line1_U.xy"
        url_l2 = "https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/tall/RE" + str(Re[i]) + "/line2_U.xy"
        url_l3 = "https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/tall/RE" + str(Re[i]) + "/line3_U.xy"
