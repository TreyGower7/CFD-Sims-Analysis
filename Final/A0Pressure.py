...
forebot2 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingMED/singleGraph/1/forebot_p_T.xy', delim_whitespace=True, header=None)
forebot3 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingLOW/singleGraph/1/forebot_p_T.xy', delim_whitespace=True, header=None)
...
foretop2 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingMED/singleGraph/1/foretop_p_T.xy', delim_whitespace=True, header=None)
foretop3 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingLOW/singleGraph/1/foretop_p_T.xy', delim_whitespace=True, header=None)
...
wakebot2 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingMED/singleGraph/1/wakebot_p_T.xy', delim_whitespace=True, header=None)
wakebot3 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingLOW/singleGraph/1/wakebot_p_T.xy', delim_whitespace=True, header=None)
...
waketop2 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingMED/singleGraph/1/waketop_p_T.xy', delim_whitespace=True, header=None)
waketop3 = pd.read_csv(f'https://raw.githubusercontent.com/TreyGower7/CFD_Code/main/Final/{mesh[0]}/postProcessingLOW/singleGraph/1/waketop_p_T.xy', delim_whitespace=True, header=None)
